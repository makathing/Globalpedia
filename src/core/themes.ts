...
export const THEMES: readonly Theme[] = [
  {
    ...
    globe: {
      ...
      fillAlpha: 1,
      grainAlpha: 0.045,
      surface: { paperFiber: 0.55, inkMottle: 0.5, lineWobble: 0.5, halftone: 0.35, aging: 0.4, gores: 0.35, varnish: 0.42, varnishRoughness: 0.52 },
      brass: 0xb8925a,
      wood: 0x4a2e1f,
      sphereTint: 0xffffff,
...

  {
    ...
    globe: {
      ocean: '#33443f',
      palette: ['#d8dcb8', '#e2c2b4', '#b6ccb4', '#c8c0d8', '#e6d2b4', '#b4d2c4', '#b2c6d6', '#d8bcc4'],
      outline: '#f2f6ee',
      outlineWidth: 2.1,
      graticule: '#dfe8e0',
      fillAlpha: 0.62,
      grainAlpha: 0.1,
      surface: { paperFiber: 0.85, inkMottle: 0.7, lineWobble: 0.9, halftone: 0, aging: 0.2, gores: 0.26, varnish: 0.04, varnishRoughness: 0.88 },
      brass: 0xb8c2be,
      wood: 0x5a6460,
      sphereTint: 0xffffff,
      keyLight: { color: 0xe8f0ea, intensity: 2.1 },
      hemiLight: { sky: 0xdfe8e0, ground: 0x6a7570, intensity: 1.2 },
      ambient: 0.4,
      labelInk: '#f6faf2',
...

  {
    ...
    globe: {
      ...
      fillAlpha: 1,
      grainAlpha: 0.075,
      surface: { paperFiber: 0.7, inkMottle: 0.8, lineWobble: 0.6, halftone: 0.45, aging: 0.9, gores: 0.6, varnish: 0.42, varnishRoughness: 0.56 },
      brass: 0xa8813c,
      wood: 0x3a2114,
      sphereTint: 0xffffff,
...

  {
    ...
    globe: {
      ...
      wood: 0x243a52,
      sphereTint: 0xffffff,
      keyLight: { color: 0xdfeeff, intensity: 2.5 },
      hemiLight: { sky: 0xcfe4ff, ground: 0x2e4560, intensity: 1.4 },
      ambient: 0.44,
      labelInk: '#eaf6ff',
...

  {
    ...
    globe: {
      ...
      fillAlpha: 1,
      grainAlpha: 0.05,
      surface: { paperFiber: 0.5, inkMottle: 0.5, lineWobble: 0.5, halftone: 0.3, aging: 0.45, gores: 0.35, varnish: 0.58, varnishRoughness: 0.46 },
      brass: 0xc9a05a,
      wood: 0x38251a,
      sphereTint: 0xffffff,
